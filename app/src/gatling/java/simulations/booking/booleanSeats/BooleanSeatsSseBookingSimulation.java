...
public class BooleanSeatsSseBookingSimulation extends BooleanSeatsBasicBookingSimulation {

    protected HttpProtocolBuilder httpProtocol = super.httpProtocol
            .sseUnmatchedInboundMessageBufferSize(1);

    protected ScenarioBuilder scn =
            createScenario("이벤트=1 좌석 예매 시나리오(SSE)")
